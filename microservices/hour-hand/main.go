...
import (
	...
	"github.com/kzmake/dapr-clock/microservices/hour-hand/infrastructure/pubsub"
	"github.com/kzmake/dapr-clock/microservices/hour-hand/infrastructure/statestore"
	"github.com/kzmake/dapr-clock/microservices/hour-hand/interface/controller"
	"github.com/kzmake/dapr-clock/microservices/hour-hand/usecase/interactor"
)
...
func main() {
	...
	if err := svc.AddTopicEventHandler(&common.Subscription{
		PubsubName: "pubsub",
		Topic:      event.Topic(event.Ticked60m{}),
		Route:      "/increase",
	}, c.Increase); err != nil {
